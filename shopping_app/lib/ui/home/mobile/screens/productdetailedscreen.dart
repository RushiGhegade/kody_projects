            ...
            children: [
              ...
              CustomButton(
                ...
                callback: () {
                  ...
                  ProductDetails p = ProductDetails(productName: product!.productName, productId: product!.productId, category: product!.category, productImage:product!.productImage, productPrice: product!.productPrice,addToCart: true);

                  if(!product!.addToCart){
                    ref.read(productListProvider.notifier).addProductTOCart(product!.productId, p);

                    if(data.isLogin){
                      LocalDatabaseHive.updateDataAddToCart(getCredential.value!.id , product!.productId,true);
                    }
