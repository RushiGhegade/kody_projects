      ...
      child: Column(
        ...
        children: [
          ...
          ActionButton(
              ...
              color: file==null ? AppColor.textColor.withOpacity(0.02):AppColor.secondaryColor,
              ...
              callback: (){
                ...
                if(file!=null){
                  ...
                  CustomSnackBar.showMySnackBar(context, "Select the Image",AppColor.errorColor,EdgeInsets.only(bottom: MediaQuery.of(context).size.height * 0.8));
