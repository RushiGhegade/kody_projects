...
import 'package:shopping_app/framework/controller/app_controller/app_controller.dart';
...
// these create the account for user
class CreateaccountScreenMobile extends ConsumerStatefulWidget {
  const CreateaccountScreenMobile({super.key});

  @override
  ConsumerState<CreateaccountScreenMobile> createState() =>
      _CreateaccountScreenMobileState();
}

class _CreateaccountScreenMobileState
    extends ConsumerState<CreateaccountScreenMobile> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Form(
              key: AppController.formKeyCreateAccountMobile,
              child: Column(
                children: [
                  EnterTextField(
                    iconData: Icons.person,
            ...
            ActionButton(
              text: "Create Account",
              callback: () async {
                // these validate the user data and data is correct then create the account for user

                if (AppController.formKeyCreateAccountMobile.currentState!
                    .validate()) {
                  if (isValid() && file != null) {
                    ...
                    LocalDataBaseSharedPref.storeLoginInfo(true, user.id);
                    LocalDataBaseSharedPref.storeCurrentUserLoginId(user.id);
                    LocalDatabaseHive.getFirstTimeData(
