...
import '../cart/helper/show_cart.dart';
...
class _OrderScreenState extends ConsumerState<OrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<ProductDetails>? orders = ref
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                return GestureDetector(
                  onTap: (){
                    ref.read(productListProvider.notifier).addFilterOrder(UiOrderFilter.values[index]);
                    ref.read(selectUiFilterProvider.notifier).state = UiOrderFilter.values[index];
                  },
                  child: Container(
                    ...
                    decoration:BoxDecoration(
                      color: uiFilter.name == UiOrderFilter.values[index].name ? AppColor.primaryColor.withOpacity(0.4) : null ,
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(color: AppColor.black)
                    ),
                    child: CustomTextWidget(text: UiOrderFilter.values[index].name,),
            ...
            (orders.isEmpty) ? Expanded(child: Center(child: CustomTextWidget(text: "No Items",))) : Expanded(
              child: ListView.builder(
                // physics: NeverScrollableScrollPhysics(),
                shrinkWrap: true,
                itemCount: orders.length,
                itemBuilder: (BuildContext context, int index) {
                  ProductDetails productDetails = orders[index];
                  return GestureDetector(
                    onTap: (){
                        print(productDetails.orderFilter.name);
                        CustomNavigation.productDetailScreenNavigation(context,true,productDetails);
                    },
                    child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              CustomTextWidget(text: " QNT : ${productDetails.orderQuantity}"),
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(10),
                                color: productDetails.orderFilter == OrderFilter.Delivered ? AppColor.successColor:null,
                                  border: Border.all(color: AppColor.black),
                                ),
                                alignment: Alignment.center,
                                child: CustomTextWidget(text: orders[index].orderFilter.name),
                              ),
