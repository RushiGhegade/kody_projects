...
class StoreProduct{
  ...
  StoreProduct copyWith({List<ProductDetails>? allProducts,List<ProductDetails>? filterProduct}){
    return StoreProduct(allProducts: allProducts??this.allProducts, filterProduct: filterProduct??this.filterProduct);
  }
