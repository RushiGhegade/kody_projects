...
/// checkout screen these screen when user click checkout in cart screen
///then he come here and these screen have system navigation stop when user
/// show the user toatl amount
/// after but all item get clear and reach to confirmation screen
